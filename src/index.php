...
<div class="index_container">
    ...
    <div class="newsroom">
        ...
        Bank also charges you when you close your account within a particular time period.</span><span>Future cuts deposit rates; PPF to fetch lower interest rate. </span><span>No, it is not mandatory to link your bank account with Aadhaar card</span></p></marquee>
    </div><br><br>
...
<p>And finally, proceed for Internet Banking Registration to create your internet banking account.
    ...
    <div class="online_services">
        ...
        <p>Future started in year 2022, is the next Generation for Online Banking. Providing customers with 24/7 support. Simple Web Browser Expereince available on Laptops, Mobiles and Electronic devices that support Web Browsing!. Register Now!
</p></div>
    
    <div class="disclaimer">
    <span>Disclaimer !!</span><br><br>
        <p>Our bank doesn't ask details of your account/PIN/password. Therefore any one pretending to be asking you for information from the bank/technical team may be fraudulent entities, so please beware.</p>
